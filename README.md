...
**Important:** ⚠️ *KCO integrations and support has been officially deprecated and will be removed in future versions of the SDK. Please migrate to [Kustom Mobile SDK](https://docs.kustom.co/contents/checkout/integrate-kco-in-your-mobile/introduction) if you are integrating KCO via `KlarnaCheckoutView`, `KlarnaHybridSDK` or `KlarnaStandaloneWebView`.*
...
If you are having any issues using the SDK in your project or if you think that something is wrong with the SDK itself, please follow our [support guide](https://github.com/klarna/klarna-mobile-sdk-android/blob/master/SUPPORT.md).

## Contribution

If you want to contribute to this project please follow our [contribution guide](https://github.com/klarna/klarna-mobile-sdk-android/blob/master/CONTRIBUTING.md).

## License

This project is licensed under 
[Apache License, Version 2.0](https://github.com/klarna/klarna-mobile-sdk-android/blob/master/LICENSE).
